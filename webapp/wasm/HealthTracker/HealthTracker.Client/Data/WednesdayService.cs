    ...
    public class WednesdayService
    {
        ...
        public ObservableCollection<ChartData> Water()
        {
            ObservableCollection<ChartData> data = new ObservableCollection<ChartData>
            {
                ...
                new ChartData { X = "09.00", Y = 0.8, Text = "09:00 - 12:00"},
                new ChartData { X = "12.00", Y = 1.5, Text = "12:00 - 15:00"},
                new ChartData { X = "15.00", Y = 0.75, Text = "15:00 - 18:00"},
                new ChartData { X = "18.00", Y = 0.75, Text = "18:00 - 21:00"},
                new ChartData { X = "21.00", Y = 0.2, Text = "21:00 - 24:00"},
            };
            return data;
        }
        ...
        public List<ChartData> StepsStepData()
        {
            List<ChartData> data = new List<ChartData>
                {
                    new ChartData { X = "Taken", Y = 6200 },
                    new ChartData { X = "Left", Y = 3800 }
                };
            return data;
        }
            ...
            List<ChartData> data = new List<ChartData>
                {
                    ...
                    new ChartData { X = "Light sleep", Y = 25, Text = "3:58 am - 5.20am" },
        ...
        public HealthData WednesDay() => new HealthData { Calories = Calorie() };
    }
}
