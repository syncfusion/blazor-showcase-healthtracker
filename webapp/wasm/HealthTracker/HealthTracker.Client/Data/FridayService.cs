    ...
    public class FridayService
    {
        ...
        public List<ChartData> Calorie()
        {
            List<ChartData> data = new List<ChartData> {
              new ChartData { X = "Protein", Y = 17 } ,
                new ChartData { X = "Fat", Y = 33 } ,
                new ChartData { X = "Fiber", Y = 8} ,
                new ChartData { X = "Calcium", Y = 15 } ,
                new ChartData { X = "Vitamins", Y = 30 } ,
                new ChartData { X = "Carbs", Y = 42 }
            };
            return data;
        ...
        public ObservableCollection<ChartData> Water()
        {
            ObservableCollection<ChartData> data = new ObservableCollection<ChartData>
            {
                ...
                new ChartData { X = "09.00", Y = 0.25, Text = "09:00 - 12:00"},
                new ChartData { X = "12.00", Y = 1, Text = "12:00 - 15:00"},
                new ChartData { X = "15.00", Y = 0.75, Text = "15:00 - 18:00"},
                new ChartData { X = "18.00", Y = 1, Text = "18:00 - 21:00"},
                new ChartData { X = "21.00", Y = 0, Text = "21:00 - 24:00"},
            };
            return data;
        }
            ...
            List<ChartData> data = new List<ChartData>
                {
                    ...
                    new ChartData { X = "Deep Sleep", Y = 5, Text = "11:24 am - 1:12 am" },
                    new ChartData { X = "Awake", Y = 3, Text = "1:12 am - 1:25 am" },
                    new ChartData { X = "REM", Y = 2.5, Text = "1:25 am - 1:52 am" },
                    new ChartData { X = "Deep Sleep", Y = 40, Text = "1:52 am - 3:45 am" },
                    new ChartData { X = "Awake", Y = 2, Text = "3:45 am - 3.58am" },
                    new ChartData { X = "Light sleep", Y = 5, Text = "3:58 am - 5.20am" },
                    new ChartData { X = "REM", Y = 2.5, Text = "5.20am - 5.47am" },
                    new ChartData { X = "Deep Sleep", Y = 30, Text = "5.47am - 7.30am" },
        ...
        public HealthData Friday() => new HealthData { Calories = Calorie() };
    }
}
