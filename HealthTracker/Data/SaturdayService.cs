...
namespace HealthTracker.Shared
{
    public class SaturdayService
    {
         ...
         public ObservableCollection<ChartData> Water()
          {
            ObservableCollection<ChartData> data = new ObservableCollection<ChartData> {
                new ChartData { X = "00.00", Y = 0.2, Text = "00:00 - 03:00"},
                new ChartData { X = "3.00", Y = 0, Text = "03:00 - 6:00"},
                new ChartData { X = "06.00", Y = 0.8, Text = "06:00 - 09:00"},
                new ChartData { X = "09.00", Y = 1.5, Text = "09:00 - 12:00"},
                new ChartData { X = "12.00", Y = 1, Text = "12:00 - 15:00"},
                new ChartData { X = "15.00", Y = 1.5, Text = "15:00 - 18:00"},
        ...
        public List<ChartData> StepsStepData()
        {
            List<ChartData> data = new List<ChartData>
                {
                    new ChartData { X = "Taken", Y = 5500 },
                    new ChartData { X = "Left", Y = 4500 }
                };
            return data;
        }
            ...
            List<ChartData> data = new List<ChartData>
                {
                    ...
                    new ChartData { X = "REM", Y = 2, Text = "1:25 am - 1:52 am" },
                    ...
                    new ChartData { X = "REM", Y = 3, Text = "5.20am - 5.47am" },
        ...
        public HealthData Saturday() => new HealthData { Calories = Calorie() };
    }
}
